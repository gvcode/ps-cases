...
A ciência de dados é profundamente relacionada com a estatística, e esta, por sua vez, tem seus fundamentos no estudo de probabilidades. Neste desafio
...
- Montar gráficos de linha para os preços de fechamento. Para montar o gráfico, você pode utilziar a biblioteca matplotlib ou seaborn. Pesquise por tutoriais dessas bibliotecas, mas abaixo damos algumas sugestões
    - COLOCA UNS TUTORIAL AQUI LAUBE
