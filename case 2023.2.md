...
Por último, os cases costumam pedir para você criar uma função. Se vocês não conseguiram aprender como criar uma, podem resolver o desafio com um código receba os valores do usuário por meio da função `input()`.
