...
Esse email faz parte do desafio 'Gerenciador de Emails' do PS GVCode 2023.2!
```

O código deve obrigatoriamente criar um documento para TODAS as pessoas incluídas na base de dados, mediante execução. 
...
$${\color{ATENÇÃO: Não deixe no código o seu e-mail e senha de login, apague-os antes de enviar. Vamos testar com as nossas próprias credenciais. Você pode também criar uma conta teste.}Red}$$
